...
//
//     final hapusBiodataIndustri = hapusBiodataIndustriFromJson(jsonString);

import 'dart:convert';

HapusBiodataIndustri hapusBiodataIndustriFromJson(String str) => HapusBiodataIndustri.fromJson(json.decode(str));

String hapusBiodataIndustriToJson(HapusBiodataIndustri data) => json.encode(data.toJson());

class HapusBiodataIndustri {
    String status;
    String message;
    Data data;

    HapusBiodataIndustri({
        required this.status,
        required this.message,
        required this.data,
    });

    factory HapusBiodataIndustri.fromJson(Map<String, dynamic> json) => HapusBiodataIndustri(
        status: json["status"],
